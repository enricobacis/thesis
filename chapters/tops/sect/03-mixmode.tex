...
Absence of a mini-block from the result will prevent reconstruction of the whole plaintext. With reference to our example in Figure~\ref{ms:fig:unmixing}, absence of $[5]_2$ will prevent reconstruction of the mini-blocks $\langle [1]_1[5]_1[9]_1[13]_1\rangle$, which in turn will prevent reconstruction of the mini-blocks $[0]_0, \ldots, [15]_0$.

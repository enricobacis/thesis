...
\begin{figure}[t]
	...
	\begin{tabular}[b]{| c | c | c | c | }	
		\hline
		\# threads &	M\&S ($mb=32$) & M\&S + OAEP ($mb=128$) & M\&S + OAEP ($mb=256$)
		\\	\hline \hline
		 1 & 1.232219 s & 7.975573 s & 10.612364 s
		\\ \hline
		 2 & 0.675429 s & 4.221637 s & 5.573989 s
		\\ \hline
		 4 & 0.377186 s & 2.203773 s & 2.873994 s
		\\ \hline
		 8 & 0.221935 s & 1.126843 s & 1.474798 s
		\\ \hline
		16 & 0.166853 s & 0.916469 s & 1.155425 s
		\\ \hline
		32 & 0.169903 s & 0.937394 s & 1.125076 s
		\\	\hline
	\end{tabular}
	\label{ms:fig:implementation}	
\end{figure}

...
\paragraph*{Chapter~\ref{chap:intro}} describes the overall scenario, the different types of network settings that we consider, and illustrates the document structure.

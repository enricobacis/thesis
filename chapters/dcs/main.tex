...
\new{
	...
	Transform (such as Mix\&Slice) with two carefully designed allocation
...
Decentralized cloud storage networks rely on voluntary
effort of a considerable number of (possibly untrusted) nodes, which
may dynamically join and leave the network at any time.
%
In \cite{globecom}
we have studied how to combine the method presented in this chapter with Fountain Codes~\cite{fountain-codes,luby2011raptorq,shokrollahi2006raptor} to better exploit the dynamicity of decentralized cloud storage networks.

...
Trusted notaries~\cite{10.1007/BFb0032349}~\cite{rabin2006time} are not suitable for all the scenarios~\cite{Abelson:1997:RKR:275079.275104}, as the data owner has to completely rely on a third party.
Therefore, cryptographers have been designing encryption techniques, known as Time-Lock Encryption (TLE)~\cite{may1993timed}, which enable the deployment of Time-Lock {\em Puzzles}~\cite{mahmoody-tl,Bitansky:2016:TPR:2840728.2840745}.
...
\begin{compactitem}
	\item Trusted Third Party benefits from a short setup time, but requires relying of trust assumption;
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\columnwidth]{fig/models}

...
%
%\para{$\honest$ is the unique sub-game perfect equilibrium for $\game{\tup{\coalitionSchema, \preceq}, \rounds}$}
%%
%\textcolor{red}{Uniqueness might follow from (1) $\game{\tup{\coalitionSchema, \preceq}, \rounds}$ is a finite game, and (2) no player is indifferent w.r.t. any two outcomes (check this!). These two assumptions are enough for uniqueness of equilibrium for extensive games with perfect information~\cite{osborne1994course}. The same should hold if we consider simultaneous moves as well.}
%\textcolor{red}{Marco: TODO!}	
\end{proof}

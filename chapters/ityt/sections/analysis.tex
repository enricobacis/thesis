...
%
%We know that $s \neq \honest$ (otherwise the outcome $\subgameOutcome{s}{e}$ would have ben exactly $a_1 \cdot a_2 \cdot \ldots \cdot a_{\rounds}$ where for all $1 \leq i \leq \rounds$ and all $C \in \coalitionSchema$, $a_i(C) = \wait$).
%%

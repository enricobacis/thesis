...
% Improve page style
\usepackage[left=40mm,right=40mm,top=45mm,bottom=45mm]{geometry}
\linespread{1.2}
...
\thispagestyle{empty}
%\vspace*{\stretch{1}}
\newgeometry{left=35mm,right=35mm,top=45mm,bottom=45mm}
\begin{abstract}
...
\newgeometry{left=40mm,right=40mm,top=45mm,bottom=45mm}
...
\bibliography{bib/options,bib/IEEEfull,chapters/intro/bib/biblio,chapters/tops/bib/biblio,chapters/dcs/bib/biblio,chapters/ityt/bib/biblio,chapters/conclusions/bib/biblio}
